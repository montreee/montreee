...
class `logging format Default - integration` : AnnotationSpec() {

    @Test
    fun `logging with format Default - integration`() {
    ...
    @Test
    fun `logging with format Default and parent logger - integration`() {
        val logs = mutableListOf<String>()
