...
class `logging format Minimal - integration` : AnnotationSpec() {

    @Test
    fun `logging with format Minimal - integration`() {
        val logs = mutableListOf<String>()
        val logger = Logger(testString()).apply {
            onLog {
                logs.add(Formats.Minimal(this))
            }
        }
    ...
    @Test
    fun `logging with format Minimal and parent logger - integration`() {
        val logs = mutableListOf<String>()
